...
export default function Sidebar({ agents, resultats, activeId, onSelect, onReset, onOpenTools, sessionInfo, user, onLogout }) {
    ...
    <aside className="w-64 flex-shrink-0 flex flex-col bg-white border-r border-tanga-sand/50 h-full">
      ...
      <div className="p-3 border-t border-tanga-sand/40 space-y-2">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-3 py-2.5 text-sm font-medium text-tanga-charcoal-light hover:bg-tanga-cream rounded-xl transition-colors"
        >
